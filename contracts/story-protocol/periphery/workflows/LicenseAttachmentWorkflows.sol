...
import {PILTerms} from "../../core/interfaces/modules/licensing/IPILicenseTemplate.sol";
    ...
    UUPSUpgradeable
{
    ...
    function setNftContractBeacon(
        ...
        if (newNftContractBeacon == address(0))
            revert Errors.LicenseAttachmentWorkflows__ZeroAddressParam();
        LicenseAttachmentWorkflowsStorage
            storage $ = _getLicenseAttachmentWorkflowsStorage();
