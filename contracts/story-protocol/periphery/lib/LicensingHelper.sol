...
import {IPILicenseTemplate, PILTerms} from "../../core/interfaces/modules/licensing/IPILicenseTemplate.sol";
...
library LicensingHelper {
    ...
    function registerPILTermsAndAttach(
        ...
        licenseTermsId = IPILicenseTemplate(pilTemplate).registerLicenseTerms(
            terms
        );
