...
import {IIPAccount} from "../../core/interfaces/IIPAccount.sol";
import {AccessPermission} from "../../core/lib/AccessPermission.sol";
...
library PermissionHelper {
    ...
    function setBatchPermissionForModules(
        ...
        AccessPermission.Permission[]
            memory permissionList = new AccessPermission.Permission[](
                modules.length
            );
        ...
        IIPAccount(payable(ipId)).executeWithSig(
            ...
            0,
            abi.encodeWithSelector(
                IAccessController.setBatchPermissions.selector,
                permissionList
            ),
            sigData.signer,
            sigData.deadline,
